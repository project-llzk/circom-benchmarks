...
template SegmentMulFixDummy(nWindows) {
 ...
 */
template EscalarMulFixDummy(n, BASE) {
    ...
    for (s=0; s<nsegments; s++) {
        ...
        segments[s] = SegmentMulFixDummy(nWindows);
